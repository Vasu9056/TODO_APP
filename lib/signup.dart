...
class _SignupState extends State<Signup> {
  ...
  Auth authclass = Auth(); // object of the Auth class
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              buttonItem(context, image1, 'Continue With Google', 25, () async {
  ...
  Widget buttonItem(context, String imglink, String text, double size,
      VoidCallback functionOnPress) {
    return InkWell(
      onTap: functionOnPress,
      child: Container(
